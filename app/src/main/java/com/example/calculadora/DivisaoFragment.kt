 ...
 * Use the [DivisaoFragment.newInstance] factory method to
...
class DivisaoFragment : Fragment() {
    ...
    private var calculo = 0.0
    /* -- ATT  27/09 --*/
    private var valorMemoria = 0.0
    //----------------- |
    ...
    override fun onCreateView(
        ...
        rootView = inflater.inflate(R.layout.fragment_divisao, container, false)
        ...
        botaoCalcular.setOnClickListener{
            ...
            if(valor1.text.isNotEmpty()) {
                if(valor2.text.isNotEmpty()) {
                    ...
                    /* - É necessaria que seja feita a conversão toDouble*/
                    val conv1 = numStr1.toDouble()
                    val conv2 = numStr2.toDouble()
                    calculo = conv1 / conv2
    ...
    companion object {
         ...
         * @return A new instance of fragment DivisaoFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            DivisaoFragment().apply {
