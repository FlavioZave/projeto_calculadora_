 ...
 * Use the [SomaFragment.newInstance] factory method to
...
class SomaFragment : Fragment() {
    ...
    /* -- Declarando as variaveis para os botões e inputs ------------- */
    ...
    override fun onCreateView(
        ...
        rootView = inflater.inflate(R.layout.fragment_soma, container, false)

        generateIntentionalError()

        /* ---- variaveis dentro do onCreateView ------ */
    ...
    private fun generateIntentionalError() {
        try {
            // Lançar uma exceção de divisão por zero intencionalmente
            val result = 10 / 0
        } catch (e: Exception) {
            // Registre a exceção no Firebase Crashlytics
    ...
    companion object {
         ...
         * @return A new instance of fragment SomaFragment.
         */
