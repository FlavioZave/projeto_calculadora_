 ...
 * Use the [SubtracaoFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class SubtracaoFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        rootView = inflater.inflate(R.layout.fragment_subtracao, container, false)
    ...
    companion object {
         ...
         * @return A new instance of fragment SubtracaoFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            SubtracaoFragment().apply {
