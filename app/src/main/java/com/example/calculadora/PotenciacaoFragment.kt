 ...
 * Use the [PotenciacaoFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class PotenciacaoFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment PotenciacaoFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            PotenciacaoFragment().apply {
